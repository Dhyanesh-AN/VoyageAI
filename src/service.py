...
Thin wrappers around the compiled `travel_graph` that start a new run, pause
at human approval, resume after review, and serialize results into a plain
dict for the API layer.
"""
...
def _serialize_result(
    ...
    return {
        ...
        "budget_risk_level": result.get("budget_risk_level", ""),
